...
// // Define types for alert settings and data structure
// type AlertSetting = {
//   id: string;
//   para: string;
//   criterion: '0' | '1' | '2' | '3';
...
//     delta_price: number;
//     delta_rating: number;
//     // Add other properties as needed from your data structure
//   };
// };
...
//   if (alertSettingsStr) {
//     const alertSettings: AlertSetting[] = JSON.parse(alertSettingsStr);
